<div class="container-fluid mt-2">
  <nav aria-label="breadcrumb">
	  <ol class="breadcrumb">
	    ...
	    <li class="breadcrumb-item active" aria-current="page">Pelaporan Dokumen Lingkungan</li>
	  </ol>
	</nav>
	...
	<?php if($doc) { ?>
		...
		<?php } else { ?>
		    ...
		    Tekan tombol "Kirim Laporan" setelah semua dokumen terlengkapi, untuk menginformasikan ke bagian verifikator Dinas Lingkungan Hidup Kab. Bojonegoro
		  </div>
		<?php } ?>
	<?php } else { ?>
		<div class="alert alert-danger">
    ...
    <div id="form_data">
	    <div class="row">
	      <div class="col-md-12">
	        ...
	        <div class="row mb-3">
	          <label class="col-md-5 col-form-label">1. Deskripsi Kegiatan <span class="text-danger">*</span></label>
	          <?php if($doc1) { ?>
