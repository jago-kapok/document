...
class Documents extends CI_Model
{
	...
	public function getDocumentDetail($doc_id, $doc_status) {
		$this->db->select('f.file_type_id, f.file_type_desc, dt.doc_id, dt.doc_detail_id, dt.doc_folder, dt.doc_file, dt.doc_status, dt.doc_modified_at, dt.doc_rejected_at, dt.doc_rejected_note');
